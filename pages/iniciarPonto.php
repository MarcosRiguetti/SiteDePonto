<?php
    ...
    if (isset($_POST['submit']))
    {
        ...
        $result = mysqli_query($conexao, "INSERT INTO pontoinicio(email,entrada) VALUES ('$email','$datahora')");
...
<body>
    ...
    <div class="box">
        ...
        <form action="iniciarPonto.php" method="POST">
            <fieldset>
                <legend class="title">Inicio Ponto</legend>
