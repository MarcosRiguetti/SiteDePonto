<?php
    ...
    if (isset($_POST['submit']))
    {
        ...
        $result = mysqli_query($conexao, "INSERT INTO pontosaida(email,saida) VALUES ('$email','$datahora')");
...
<body>
    ...
    <div class="box">
        ...
        <form action="saidaPonto.php" method="POST">
            <fieldset>
                <legend class="title">Saida Ponto</legend>
